...
class YulCleaner {
   public:
    ...
    YulCleaner(std::string sol_src, std::string main_contract,
               std::string contractPath, std::vector<std::string> storageVars);
   ...
   private:
    ...
    std::pair<std::string, int> endOfCaseBlock(
