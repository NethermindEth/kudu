...
interface IERC721Metadata is IERC721 {
     ...
     */
    function symbol() external view returns (uint);
...
contract ERC721 is Context, ERC165, IERC721, IERC721Metadata {
     ...
     */
    constructor(uint name_, uint symbol_) {
        _name = name_;
        _symbol = symbol_;
    }
     ...
     */
    function name() public view virtual override returns (uint) {
        return _name;
    }
     ...
     */
    function symbol() public view virtual override returns (uint) {
        return _symbol;
    }
...
contract KongsNFT is ERC721, ERC721Enumerable, Ownable {
   using Counters for Counters.Counter;
    Counters.Counter public _tokenIds;
    
    uint16 public constant maxSupply = 5000;
    uint[] public _baseTokenURI;
    
    uint256 public _startDate = 1630936800;

    constructor() ERC721(42, 1722) {
    }
    ...
    function setBaseURI(uint[] memory _newbaseTokenURI) public onlyOwner {
        tester[0] = _newbaseTokenURI;
        _baseTokenURI = _newbaseTokenURI;
    }

    function _baseURI() internal view returns (uint[] memory) {
